...
map.getView().fit([8518202.741401, 922281.660376, 8654168.306967, 1010030.362382], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">TRIVANDRUM DISTRICT</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (173 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This is an elaborated map of Trivandrum district. This  map includes information about junctions, roads, railways, beaches, drainage, geomorphology, soil type of Trivandrum.';
            }
